...
// --------------------- Parent Modal ---------------------
export const RegisterModal_Admin = ({ onClose, onSuccess }) => {
  ...
  const dummyRecruitmentData = {
    data: [
      ...
      },
      {
        ...
        firstName: "Sarah",
        lastName: "Williams",
        personalEmail: "sarah.williams@example.com",
        personalMobile: "+1234567893",
        jobRole: "Director",
  ...
  const recruitmentData = dummyRecruitmentData;
