...
const LeaveManagementForm = ({ onClose }) => {
    ...
    return (
        <div className=" fixed  inset-0 bg-slate-900/40 backdrop-blur-md flex items-center justify-center z-50 p-4 animate-in fade-in duration-300">
            <div className="w-full max-w-4xl  md:rounded-2xl  flex flex-col max-h-screen md:max-h-[90vh] overflow-auto relative custom-scrollbar">


                <div className="min-h-screen md:p-8 font-sans ">
                    <div className="flex justify-end w-full ">
                        <button className="  text-white  cursor-pointer  hover:text-white/60  p-3 rounded-full  bg-white/10 hover:rotate-90 transition-all duration-200 " onClick={onClose}><X size={25}  className=""/></button>
                    ...
                    <div className="max-w-5xl mx-auto pt-2">
                        <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-200">
                            ...
                            <div className="bg-gradient-to-br from-amber-500 to-amber-600 p-4 md:p-10 text-white">
                                <div className="flex flex-col lg:flex-row text-center lg:text-start md:text-start items-center gap-3 mb-2">
                            ...
                            <form onSubmit={handleSubmit} className="p-8">
                                ...
                                {/* Leave Details Card */}
                                <div className="mb-10 bg-white rounded-2xl p-6">
