...
import LeaveManagementForm from "./leave_,mgt_client";
// import Attend_Mgt_Client_form from "../attend_mgt_client";
...
const Attend_HR_Data_Table = () => {
  ...
  const [AttenOpen, setAttenIsOpen] = useState(false)
  const [LeaveOpen, setLeaveIsOpen] = useState(false)
  ...
  return (
    <div className="p-6 min-h-screen relative">
        ...
        <div className="mb-8 grid grid-cols-1">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            ...
            <div className="flex flex-row gap-3 w-full md:w-auto">
              ...
              <div class="flex flex-col items-center gap-4" onClick={() => { setAttenIsOpen(prev => !prev) }}>

                <button class="inline-flex items-center gap-4 pl-8 pr-2 py-2 bg-amber-500/10 hover:bg-amber-500/20 active:bg-amber-500/30 text-amber-700 font-bold rounded-full border border-amber-200 transition-all duration-200 group">
                  <span class="tracking-wide">Attendance</span>

                  <div class="flex items-center justify-center w-10 h-10 bg-amber-500 text-white rounded-full shadow-md group-hover:scale-105 transition-transform">
                    <PlusCircle size={25} />
                  </div>
                </button>
              ...
              <div class="flex flex-col items-center gap-4" onClick={() => { setLeaveIsOpen(prev => !prev) }}>

                <button class="inline-flex items-center gap-4 pl-8 pr-2 py-2 bg-amber-500/10 hover:bg-amber-500/20 active:bg-amber-500/30 text-amber-700 font-bold rounded-full border border-amber-200 transition-all duration-200 group">
                  <span class="tracking-wide">Leave</span>
      ...
      <div className="absolute top-0 left-0   w-full ">
        ...
        {
          AttenOpen && (
            <div className="relative inset-0  top-0 bg-white  lg:h-[66rem] md:h-[66rem]  sm:h-[69rem] h-[87rem] ">

              <Attend_Mgt_Client_form onClose={handleAttendClose} />
            </div>
          )
        ...
        }
        {
          LeaveOpen && (
            <div className="relative inset-0  top-0 bg-white  lg:h-[66rem] md:h-[66rem]  sm:h-[69rem] h-[87rem] ">
              ...
              <LeaveManagementForm onClose={handleLeaveClose} />
            </div>
          )
