        ...
        <div className="min-h-screen bg-white p-4 md:p-6">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 gap-6 mb-6">
                    {/* Projects Management */}
                    <div className="bg-white  p-6 border-b-2  border-amber-100">
                        <div className="flex items-center gap-3 mb-6">
                        ...
                        <div className="space-y-4">
                            {projects.projectsList.map((project) => (
                                <div key={project.id} className="border border-slate-200 rounded-xl p-4 hover:border-amber-300 transition-all duration-300 hover:shadow-md">
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center gap-2 mt-1">
                                                    ...
                                                    <span className={`text-xs px-2 py-1 rounded-full ${project.priority === 'critical' ? 'bg-red-100 text-red-800' :
                                    ...
                                    <div className="grid grid-cols-2 gap-3 text-sm mb-3">
                                        <div className="flex items-center gap-2 text-gray-600">
                                            ...
                                            <span>{project.handlePerson}</span>
                                        </div>
                                        <div className="flex items-center gap-2 text-gray-600">
                                    ...
                                    <div className="mt-3">
                                        ...
                                        <div className="w-full bg-gray-200 rounded-full h-2">
                                            <div
                                                className={`h-2 rounded-full ${project.progress < 30 ? 'bg-red-500' :
                                    ...
                                    {/* Priority Selector with react-select */}
                                    <div className="mt-4">
                                        <div className="flex items-center gap-3">
                                            <label htmlFor={`priority-${project.id}`} className="text-sm font-medium text-gray-700">
                                                Set Priority:
                                            </label>
                                            <div className="flex-1">
                                                <Select
                                                    ...
                                                    defaultValue={
                                                        project.priority === 'high' ? { value: 'high', label: 'High' } :
                                                            project.priority === 'medium' ? { value: 'medium', label: 'Medium' } :
                                                                { value: 'low', label: 'Low' }
                                                    }
                                                    styles={{
                                                        control: (base, state) => ({
